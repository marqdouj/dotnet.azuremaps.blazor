...
namespace Sandbox
{
    internal static class AzMapsSetup
    {
        ...
        public static IServiceCollection ConfigureMarqdoujAzMaps(this IServiceCollection services, IConfiguration configuration)
        {
