...
namespace Sandbox.Components.Pages.AzureMaps
{
    internal static class LayerExtensions
    {
        ...
        public static async Task<MapLayerDef> AddBasicMapLayer(this IAzMapInterop mapsInterop, IMapDataService dataService, MapLayerType layerType, IEnumerable<MapEventDef>? events = null, bool zoomTo = true)
        {
            return await mapsInterop.AddBasicMapLayer(dataService, await layerType.GetDefaultLayerDef(dataService), events, zoomTo);
        }

        public static async Task<MapLayerDef> AddBasicMapLayer(this MapLayerDef layerDef, IAzMapInterop mapsInterop, IMapDataService dataService, IEnumerable<MapEventDef>? events = null, bool zoomTo = true)
        {
            return await mapsInterop.AddBasicMapLayer(dataService, layerDef, events, zoomTo);
        }

        public static async Task<MapLayerDef> AddBasicMapLayer(this IAzMapInterop mapsInterop, IMapDataService dataService, MapLayerDef layerDef, IEnumerable<MapEventDef>? events = null, bool zoomTo = true)
        {
        ...
        private static async Task<MapLayerDef> AddBubbleLayer(IAzMapInterop mapsInterop, IMapDataService dataService, BubbleLayerDef layerDef, bool zoomTo = true, IEnumerable<MapEventDef>? events = null)
        {
        ...
        private static async Task<MapLayerDef> AddLineLayer(IAzMapInterop mapsInterop, IMapDataService dataService, LineLayerDef layerDef, bool zoomTo, IEnumerable<MapEventDef>? events = null)
        {
            await mapsInterop.Layers.Add([layerDef], events);
        ...
        private static async Task<MapLayerDef> AddPolygonExtLayer(IAzMapInterop mapsInterop, IMapDataService dataService, PolygonExtLayerDef layerDef, bool zoomTo, IEnumerable<MapEventDef>? events = null)
        {
            await mapsInterop.Layers.Add([layerDef], events);
        ...
        private static async Task<MapLayerDef> AddSymbolLayer(IAzMapInterop mapsInterop, IMapDataService dataService, SymbolLayerDef layerDef, bool zoomTo, IEnumerable<MapEventDef>? events = null)
        {
            await mapsInterop.Layers.Add([layerDef], events);
        ...
        private static async Task<MapLayerDef> AddTileLayer(IAzMapInterop mapsInterop, IMapDataService dataService, TileLayerDef layerDef, bool zoomTo, IEnumerable<MapEventDef>? events = null)
        {
            await mapsInterop.Layers.Add([layerDef], events);
